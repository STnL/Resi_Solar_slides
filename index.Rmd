...
* the average electricity usage per user as reported by Australia's Energy Regulator (AER) which is `r average_usage_per_person` KWh.
* the living space (in square meters) of the user.
* the average generation of the 90th percentile of solar panels in Australia which is `r avg_solar_gen` KWh.
* the average usage per household in Eastern Australia which is `r avg_solar_gen` KWh.
